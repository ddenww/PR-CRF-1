@echo off
rem C:\Users\Anku\Documents\Wen\code\crfChain\mymex\mexopts.bat
rem Generated by gnumex.m script in C:\users\anku\DOCUME~1\wen\code\gnumex2.06
...
rem Matlab version 8.1
rem
set GCCINSTALLDIR=C:\MinGW\bin
set MATLAB=C:\PROGRA~1\MATLAB\R2013a
set GM_PERLPATH=C:\PROGRA~1\MATLAB\R2013a\sys\perl\win32\bin\perl.exe
set GM_UTIL_PATH=C:\users\anku\DOCUME~1\wen\code\gnumex2.06
...
set GM_QLIB_NAME=C:\Users\Anku\DOCUME~1\Wen\code\crfChain\mymex
rem
rem directory for .def-files
set GM_DEF_PATH=C:\Users\Anku\DOCUME~1\Wen\code\crfChain\mymex
rem
...
set GM_MEXDEF=C:\Users\Anku\DOCUME~1\Wen\code\crfChain\mymex\mex.def
rem
...
set LINKFLAGS= -LC:\Users\Anku\DOCUME~1\Wen\code\crfChain\mymex
set LINK_FILE=
set LINK_LIB=
