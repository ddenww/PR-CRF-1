...
path = 'D:\work\2_LEARNING\CRFChain\crfChain_Partial_Regularized_cleaned\debug\'; 
debugfilename = 'debugRecordsCrfChain_loss.txt';
debugfilename = strcat(path,debugfilename);
fid=fopen(debugfilename,'a+');
